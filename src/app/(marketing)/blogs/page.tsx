        ...
        <div className="bg-cream py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="font-serif font-black tracking-tighter leading-[1.02] text-ink text-[clamp(32px,5vw,48px)]">
                        Our Latest Articles
                    </h2>
                    <p className="mt-4 text-[clamp(16px,1.8vw,18px)] leading-[1.85] text-ink-secondary font-light">
                ...
                <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {blogs.length === 0 ? (
                        <div className="col-span-full pt-12 pb-24 text-center text-ink-muted">
