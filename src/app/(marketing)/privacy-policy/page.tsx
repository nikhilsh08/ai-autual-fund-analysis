    ...
    return (
        <div className="min-h-screen bg-cream py-12 px-4 sm:px-6 lg:px-8 font-sans text-ink">
            <div className="max-w-3xl mx-auto">
                ...
                {/* Title */}
                <h1 className="text-3xl font-bold font-serif mb-8 text-ink">Privacy Policy</h1>

                <div className="bg-card rounded-2xl shadow-sm border border-border p-8 md:p-10 space-y-10">

                    <section>
                        <h2 className="text-lg font-bold text-ink mb-3">Consent</h2>
                    ...
                    <section>
                        ...
                        <p className="text-sm text-ink-secondary mb-3">We use the information we collect in various ways, including to:</p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-ink mb-3">Log Files & Cookies</h2>
                        <p className="text-sm text-ink-secondary mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-ink mb-3">GDPR Data Protection Rights</h2>
                        <p className="text-sm text-ink-secondary mb-3">
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-ink mb-3">Contact Us</h2>
                        <p className="text-sm text-ink-secondary">
                            If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.
                        </p>
                        <p className="text-sm text-ink font-medium mt-2">Email: support@cashflowcrew.in</p>
                    </section>
