...
export const CourseNeedHelp = () => {
    return (
        <>
            {/* Money-Back Guarantee Section */}
            <section className="border-t border-border text-center py-12 sm:py-16 bg-white">
                <div className="max-w-[520px] mx-auto px-5 md:px-7">
                    <div className="text-4xl mb-3">🛡️</div>
                    <h3 className="font-serif text-xl sm:text-2xl font-black text-ink mb-2">
                        100% Money-Back Guarantee
                    </h3>
                    <p className="text-sm text-ink-secondary leading-relaxed font-light">
                        Not satisfied? Email support@cashflowcrew.in within 7 days. Complete refund. No questions. No hoops.
                    </p>
                </div>
            </section>

            {/* Need Help Section */}
            <section className="bg-cream-dark border-t border-border py-12 sm:py-16">
                <div className="max-w-[680px] mx-auto px-5 md:px-7">
                    <div className="text-[11px] tracking-[.14em] uppercase text-ink-muted flex items-center justify-center gap-2.5 mb-6">
                        <span className="w-[18px] h-px bg-ink-muted shrink-0" />
                        need help?
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {/* Group Doubt-Clearing Card */}
                        <div className="p-7 px-6 bg-white rounded-2xl border border-border text-center flex flex-col items-center">
                        ...
                        <div className="p-7 px-6 bg-white rounded-2xl border border-border text-center flex flex-col items-center">
                            ...
                            <a
                                href="#"
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-pill text-[13px] font-medium bg-ink text-cream hover:-translate-y-px transition-transform"
                            >
                                book a session →
                            </a>
