      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-center mb-16">
          <div className="text-center">
            <span className="text-xs font-medium text-blue-600 uppercase tracking-widest mb-2 block">Investment Strategies</span>
            <h2 className="text-4xl font-medium tracking-tighter text-zinc-900">
              Master the art of <span className="text-zinc-400">Wealth Creation</span>
            </h2>
          </div>
        </div>
